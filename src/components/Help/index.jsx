...
const IconGitHub = () => (
  <svg className="contact-icon-svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    <div className="help-page-container">
      ...
      <div className="help-content">
        ...
        <section className="help-section tracking-section">
          ...
          {isLoading && (
            <div className="local-loading-wrapper">
          ...
          {trackingResult && !isLoading && (
            <div className="tracking-result-card">
              <div
                className="tracking-status-indicator"
                style={{ backgroundColor: trackingResult.color }}
              />
